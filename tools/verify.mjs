...
if (!nextRoutingControlBlock.includes("toggle.blur?.()") || !nextRoutingControlBlock.includes("_captureEditorPosition()") || !nextRoutingControlBlock.includes("_stabilizeEditorPosition(position)")) errors.push("Counter-routing toggle must drop hidden-checkbox focus and preserve ApplicationV2 geometry");
