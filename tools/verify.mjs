...
if (!playerSource.includes("participantIds: [...this.participantIds]") || !playerSource.includes("if (Array.isArray(payload.participantIds))") || !playerSource.includes("this.participantIds = uniqueIds(payload.participantIds)")) errors.push("Vote-state synchronization must carry current participant membership to all remaining clients");
